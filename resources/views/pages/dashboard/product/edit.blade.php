								...
								<div class="-mx-3 mb-6 flex flex-wrap">
										<div class="w-full px-3">
												...
												<textarea name="description"
												  class="block w-full rounded border border-gray-400 bg-gray-50 px-4 py-3 leading-tight text-gray-700 focus:border-gray-500 focus:bg-white focus:outline-none">{!! old('description') ?? $product->description !!}</textarea>
										</div>
								</div>
								<div class="-mx-3 mb-6 flex flex-wrap">
										<div class="w-full px-3">
